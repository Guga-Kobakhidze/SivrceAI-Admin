...
// Correct Version when i resive img_url and
...
// const MultiImageFieldElement: React.FC<MultiImageFieldElementProps> = ({
//   name,
//   label,
//   images,
//   disabled,
...
//           {images?.slice(0, 8).map((img, index) => {
//             const src =
//               img.img_url || (img.file ? URL.createObjectURL(img.file) : '')
